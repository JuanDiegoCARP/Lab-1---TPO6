...
//                JOptionPane.showMessageDialog(this, "Producto eliminador");
//                jbEliminar.setEnabled(false);
//                limpiar();
//                return;
//            }
...
//        JOptionPane.showMessageDialog(this, "Producto no encontrado");
    ...
    private void jbGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbGuardarActionPerformed
        ...
        Categoria cat=(Categoria)jcProducto.getSelectedItem();
        
        Producto a = new Producto(codigo, descripcion, precio, stock, cat);
        if (productos.add(a)) {
        ...
        try {
            ...
            for (Producto producto : productos) {
                if (producto.getCodigo()==codigo) {
                    ...
                    jcProducto.setSelectedItem(producto.getCategoria());
            ...
            JOptionPane.showMessageDialog(this, "Ingrese un numero en codigo");
        }
